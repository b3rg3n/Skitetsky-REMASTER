...
label aktfour:
    ...
    nvl clear
    nvlivt "Я осталсь думать,{w=0.2} чё же делать дальше?"
    nvlivt "Порыскав по комнате,{w=0.2} нашла люк."
    nvl clear
    play sound stmetal
    scene vent with ed_lap
    nvlivt "Вентиляционная шахта, {w=0.2}значит..."
    ...
    nvlvas "И не раз."
    nvl clear
    nvlivt "Вместе с твоей,{w=0.2} не забывай."
    nvl clear
    ...
    nvlivt "Да так довыёбываешься,{w=0.2} что я с разбегу под колёса проезжающей машини сигану."
    nvlivt "И не будет ни меня,{w=0.2} ни тебя."
    nvlivt "Вот и всё блять."
    nvlivt "Распизделась она тут,{w=0.2} видите ли."
    nvl clear
    nvlvas "Успокойся."
    nvl clear
    ...
    nvl clear
    nvlivt "Успокоится?"
    nvlivt "А,{w=0.2} может,{w=0.2} ты просто на хуй пойдёшь?"
    nvlivt "Заебала,{w=0.2} в натуре."
    nvl clear
    nvlivt "Всё ей не нравится."
    nvlivt "Пыталась решить вопрос с гопниками в лагере -{w} опять не так."
    nvlivt "Пыталась решить вопрос с сизо -{w} снова не так бля."
    nvlivt "Наебенила я этих мудаков -{w} да всё не так блять!"
    nvl clear
    nvlivt "Чё?"
    nvlivt "Скажи,{w=0.2} чё тебе не нравится на этот раз?"
    nvl clear
